...
@WebServlet("/subscreveAtividadesIndividuaisServlet")
public class subscreveAtividadesIndividuaisServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //Faz o cliente subscrever-se a manchas de disponibilidade individuais (do seu PT)
